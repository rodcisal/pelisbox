...
class PeliculasControllerTest < ActionController::TestCase
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post :create, pelicula: { descripcion: @pelicula.descripcion, iframe: @pelicula.iframe, imagen: @pelicula.imagen, titulo: @pelicula.titulo }
    end
  ...
  test "should update pelicula" do
    put :update, id: @pelicula, pelicula: { descripcion: @pelicula.descripcion, iframe: @pelicula.iframe, imagen: @pelicula.imagen, titulo: @pelicula.titulo }
    assert_redirected_to pelicula_path(assigns(:pelicula))
  end
